				...
				<div class="inner">
					...
					<!--���������� -->
						...
						<table align="center" border="1" style="width:700px;" class="myinfo">
							<tr>
								<td class=myinfos style="width:70px; height:20px;" >�ֹ�����</td>
							...
							<tr>
								...
								<td style="width:100px;">�Ƹ޸�ī��Ice</td>
								<td class=myinfos style="width:70px;">1500��</td>
								<td style="width:30px;">�ſ�ī�� </td>
							</tr>
							<tr>
								<td class=myinfos style="width:70px;">2022-03-05 14:47:05 </td>
								<td style="width:100px;">ī�����Ice</td>
								<td class=myinfos style="width:70px;">2000��</td>
								<td style="width:30px;">�ſ�ī�� </td>
							</tr>
