...
<%@ include file="order_include/header.jsp" %>
			<tr>
				<td width="125px">
					<a class="btn all menu" href="index.jsp">��ü �޴�</a>
				</td>
				<td colspan="3">
					<a href="mymenu.jsp">������ �޴�</a>
				</td>		
			...
			<tr>
				<td width="150px">
					<a class="btn all menu" href="index.jsp">����</a>
				</td>
				<td width="125px" colspan="3">
					<a href="index.jsp?kind=side">���̵� �޴�</a>
				</td>
			</tr>
			<tr>
				<td colspan="4" style="border-top:10px;height:1px;background-color:#000000"></td>
			...
			<tr>
				<td style="width:125px; height:80px">
					<a href="view.jsp"><img width="125px"src="https://www.paris.co.kr/wp-content/uploads/%E1%84%8B%E1%85%A1%E1%84%86%E1%85%A6%E1%84%85%E1%85%B5%E1%84%8F%E1%85%A1%E1%84%82%E1%85%A9-1280x1280.jpg"></a>
				</td>
				<td colspan="3">
					<a href="view.jsp">���̽��Ƹ޸�ī��</a>
				</td>
			</tr>
			<tr>
				<td style="width:125px; height:80px">
