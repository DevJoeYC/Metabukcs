...
function putItemIntoCart() {
	...
	item_no = document.querySelector("#pro_no").innerText;
	...
	const par		= document.getElementById("cart");		//부모 객체
...
세부이름:<br><span>${name}</span><br>
한글이름:<br><span>${hname}</span><br>
...
function UpdateIMG(){
	var item_no	= document.getElementById("pro_no").innerText;//상품 번호
	item_no = document.querySelector("#pro_no").innerText;
	var strURL = "./product/modify.jsp?pro_no="+item_no;
